	...
	public void launching_Multiple_Browser() throws InterruptedException {
		...
		if(Browser.equals("Chrome")) {
			 ...
			 WebDriver driver1 = new ChromeDriver();
		        ...
		        Thread.sleep(2000);
		        driver1.findElement(By.name("email")).sendKeys("Aamir");
		        Thread.sleep(2000);
			...
			if(Browser.equals("Firefox")) {
				...
				System.setProperty("webdriver.gecko.driver","C:\\Users\\Md Aamir Reza\\Downloads\\geckodriver-v0.31.0-win64\\geckodriver.exe");
				 ...
				 driver1.get("https://www.facebook.com/");
				  ...
				  System.setProperty("webdriver.edge.driver","C:\\Users\\Md Aamir Reza\\Downloads\\edgedriver_win64\\msedgedriver.exe");
				...
				System.setProperty("webdriver.ie.driver","C:\\Users\\Md Aamir Reza\\Downloads\\IEDriverServer_x64_4.3.0\\IEDriverServer.exe");
